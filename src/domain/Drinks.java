...
public class Drinks {
    ...
    public void addNew(){
        String line = String.join("|", Integer.toString(this.getId()), this.getName(), this.getQuantity(), this.getPrice(), this.getSupplier());
        line += System.lineSeparator();//breakline
        writeTo(line, StandardOpenOption.CREATE, StandardOpenOption.APPEND);
    }
    public void edit(){
        String newline = String.join("|", Integer.toString(this.getId()), this.getName(), this.getQuantity(), this.getPrice(), this.getSupplier());
...
//        System.out.println( new Drinks().getAll() );
       Drinks newDrinks = new Drinks();
        newDrinks.setId(21);
        newDrinks.setName("MountainDrew");
        newDrinks.setQuantity("150");
        newDrinks.setPrice("2.00");
        newDrinks.setSupplier("The Cola-cola Company");
        newDrinks.addNew();
//        newDrinks.edit();
    }
}
